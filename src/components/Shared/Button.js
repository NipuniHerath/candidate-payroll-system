...
const Button = ({
  ...
  const baseStyles = `font-medium text-sm text-center rounded-full  `;


  const variants = {
  
    signIn:"text-gray-900 rounded-full bg-white hover:bg-gray-100 border-2  border-[#202A44] focus:ring-2 focus:outline-none focus:ring-gray-100 font-medium text-sm px-8 py-4  flex justify-center items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 me-2 mb-2",
    signUp: `text-white bg-[#202A44] rounded-full border-2 hover:bg-[#2c3a5e]  border-[#e4e4e7] focus:ring-gray-100 font-medium text-sm px-8 py-4 flex justify-center items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 me-2 mb-2`,
